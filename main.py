...
def main():
    ...
    def loading():
        ...
        loading = 0
        loading_time = 0
        fon1 = load_image('Loading1.png')
        loading_fons.append(fon1)
        fon2 = load_image('Loading2.png')
    ...
    def start_screen():
        ...
        count_fon = 0
        start_fons = []
        fon0 = load_image('START1.png')
        start_fons.append(fon0)
        fon1 = load_image('ChickenRun.png')
        start_fons.append(fon1)
        fon2 = load_image('Chicken_anim_fon1.png')
        start_fons.append(fon2)
        fon3 = load_image('Chicken_anim_fon2.png')
        start_fons.append(fon3)
        fon4 = load_image('Chicken_anim_fon3.png')
        start_fons.append(fon4)
        fon5 = load_image('Chicken_anim_fon4.png')
